...
<div class="main-container" style="max-width: 1200px; margin: 0 auto; padding: 20px;">
    ...
    <div class="hero-section" style="text-align: center; padding: 40px 20px; margin-bottom: 50px; 
        ...
        <p style="font-size: 1.2rem; color: var(--pale-red); margin-bottom: 30px; max-width: 600px; margin: 0 auto 30px;">
    ...
    <div style="margin-bottom: 60px;">
        ...
        <?php else: ?>
            ...
            <div style="text-align: center; margin-top: 30px; padding: 15px; background: rgba(226, 48, 32, 0.05); 
                ...
                <a href="<?php echo SITE_URL; ?>index.php?page=movies" 
                   style="color: var(--light-red); text-decoration: none; font-weight: 600; display: inline-flex; 
    ...
    <div style="margin-top: 60px; text-align: center;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 30px; margin-top: 30px;">
            <div style="background: linear-gradient(135deg, var(--bg-card) 0%, var(--bg-card-light) 100%); 
                ...
                <p style="color: var(--pale-red); line-height: 1.6;">Get access to the newest releases and blockbuster hits</p>
            </div>
            ...
            <div style="background: linear-gradient(135deg, var(--bg-card) 0%, var(--bg-card-light) 100%); 
                ...
                <p style="color: var(--pale-red); line-height: 1.6;">Choose your preferred seats with our interactive seat map</p>
            </div>
    ...
    <div style="text-align: center; margin-top: 80px; padding: 50px; 
        ...
        <p style="color: var(--pale-red); font-size: 1.1rem; margin-bottom: 30px; max-width: 600px; margin-left: auto; margin-right: auto;">
            Join thousands of movie lovers who book their tickets with us. Create an account and start your cinematic journey today!
        </p>
        <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
            <a href="<?php echo SITE_URL; ?>index.php?page=register" 
               class="btn btn-primary" style="padding: 15px 35px; font-size: 1.1rem;">
                <i class="fas fa-user-plus"></i> Sign Up Now
            </a>
            <a href="<?php echo SITE_URL; ?>index.php?page=login" 
               class="btn btn-secondary" style="padding: 15px 35px; font-size: 1.1rem;">
